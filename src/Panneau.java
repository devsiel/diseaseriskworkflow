...
public class Panneau extends JPanel {
    ...
    //boolean pour le mode morphing et pour savoir si la taille doit tre rŽduite
    ...
    /**
     * MŽthode qui redŽfinit la couleur du fond
     * @param color
     */
    ...
    /**
     * MŽthode qui redŽfinit la couleur de la forme
     * @param color
     */
    ...
    private void draw(Graphics g){
    	...
    	if(this.forme.equals("CARRE") || this.forme.equals("CARRƒ")){
    ...
    /**
     * MŽthode qui retourne le nombre ˆ retrancher ou ajouter pour le morphing
     * @return res
     */
