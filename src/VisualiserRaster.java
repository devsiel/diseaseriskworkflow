...
//		this.fenvis.setLocationRelativeTo(null);
//		this.fenvis.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
//		this.fenvis.setTitle("Affichage Raster");
//		this.fenvis.setSize(500, 240);
        ...
        if(img!=null) g.drawImage(img.getImage(), 10, 30, plotter);
			...
			code.addRCode("plot(layers, main=\"Raster"+rasters.get(i)+"\")");
			...
			code.endPlot();
			//System.out.println("Fin du Plot will be saved to : " + file2);
